...
def fetch_data(numStages, numSubperiods, numSubterms, epsilon = 0):
    ...
    electricity_demand_nominal = aggregating_nominal_data(base_electricity_demand, subterm_length)
    electricity_demand_std = aggregating_std_data(base_electricity_demand_std, subterm_length)
    ...
    heat_demand_nominal = aggregating_nominal_data(base_heat_demand, subterm_length)
    heat_demand_std = aggregating_std_data(base_heat_demand_std.tolist(), subterm_length)
    ...
    solar_periodic_generation_nominal = [aggregating_nominal_data(row, subterm_length) for row in base_solar_periodic_generation]
    solar_periodic_generation_std = [aggregating_std_data(row, subterm_length) for row in base_solar_periodic_generation_std]
    ...
    wind_periodic_generation_nominal = [aggregating_nominal_data(row, subterm_length) for row in base_wind_periodic_generation]
    wind_periodic_generation_std = [aggregating_std_data(row, subterm_length) for row in base_wind_periodic_generation_std]
    ...
    parabolic_trough_periodic_generation_nominal = [aggregating_nominal_data(row, subterm_length) for row in base_parabolic_trough_periodic_generation]
    parabolic_trough_periodic_generation_std = [aggregating_std_data(row, subterm_length) for row in base_parabolic_trough_periodic_generation_std]
    ...
    heat_pump_cop_nominal = [aggregating_nominal_cop(row, subterm_length) for row in base_heat_pump_cop_nominal]
    heat_pump_cop_std = [aggregating_std_cop(row, subterm_length) for row in base_heat_pump_cop_std]
