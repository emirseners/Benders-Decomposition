...
if __name__ == '__main__':
    ...
    valid_inequalities_flag = [False, True]
    worst_sp_incumbent_flag = [False, True]
    continuous_flag = [False, True]
    callback_flag = False
    master_threads = 4
    ...
    for inc in worst_sp_incumbent_flag:
            ...
            for cont in continuous_flag:
                for numSubterms in numSubterms_levels:
                    for epsilon in epsilon_levels:
                        ...
                        folder_suffix = f"eps({epsilon})_cont({cont})_vi({vi})_inc({inc})"
